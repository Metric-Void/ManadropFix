...
public interface ConfigurationSection {
     ...
     * please use {@link #createSection(String)} for that.
     *
     * @param key   Key of the object to set. Dots will not be parsed.
     * @param value New value to set the path to.
     */
    ...
    /**
     * Creates an empty {@link ConfigurationSection} at the specified key.
     * Dots in the path will not be parsed.
     * <p>
     * Any value that was previously set at this path will be overwritten. If
     * the previous value was itself a {@link ConfigurationSection}, it will
     * be orphaned.
     *
     * @param key Path to create the section at.
     * @return Newly created section
     */
    ConfigurationSection createSectionRaw(final String key);
